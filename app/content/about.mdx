...
As I neared graduation, though, I realized that software development was
...
After working and living in Chicago for a little over 2 years, I decided it was time for a new job. My wife and I both wanted to stay in Chicago longer, but I was unexpectedly offered a job by a company in Salt Lake City called [Objective](https://www.objective.dev/). As is often the case, life doesn't go according to plan and we decided I would take the job and move back to Utah in September 2021.

Now, I'm working for Objective and trying to get involved in open source in my free time. Currently, my favorite OSS project is [Remix](https://remix.run/), which I've been keeping up with for the last couple years. I'm hoping that as I discover more problems that need to be solved, I'll get an OSS project of my own out there.
